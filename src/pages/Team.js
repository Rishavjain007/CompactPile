import { Mail, Linkedin, BadgeCheck, BriefcaseBusiness, Users } from 'lucide-react';
    ...
    <div className="min-h-screen pt-20 bg-white dark:bg-gray-950">
      ...
      <section className="relative py-24 bg-gradient-to-r from-[#BA0014] via-[#a00012] to-[#7f000d] overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-red-100 max-w-3xl mx-auto leading-relaxed">
            ...
            geotechnical engineering, and project execution.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Experienced leadership with decades of knowledge in civil engineering,
              foundation systems, testing, and field operations.
            </p>
          </div>
            ...
            {leadershipTeam.map((member) => (
              ...
              >
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <Badge className="mb-4 bg-[#BA0014]/10 text-[#BA0014] dark:bg-[#BA0014]/20 dark:text-red-200 border border-[#BA0014]/20">
                    {member.designation}
                  </Badge>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-950">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              A dedicated team of engineers, technical professionals, and operational staff
              supporting execution, quality, coordination, and project delivery.
            </p>
          </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Multi-disciplinary expertise across testing, field execution, quality systems,
              instrumentation, and engineering operations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8 text-center rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                A long-standing presence in foundation engineering, testing, and execution support.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Engineers, technicians, and operational staff supporting projects across India.
              </p>
            </Card>
            ...
            <Card className="p-8 text-center rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Strong coordination between engineering, site operations, reporting, and project support.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Our team combines field-tested execution with engineering understanding and
              technical discipline across major infrastructure projects.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 rounded-2xl border-l-4 border-[#BA0014] border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
              ...
              <ul className="space-y-4 text-gray-600 dark:text-gray-400">
                <li className="flex items-start">
                  ...
                  <span>Civil engineers and specialists with strong academic and field backgrounds</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Hands-on expertise in PIT, CHSL, dynamic load testing, and static load testing</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Practical understanding of foundation behavior, instrumentation, and reporting</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Continuous focus on standards, quality control, and execution efficiency</span>
                </li>
              </ul>
            </Card>
            ...
            <Card className="p-8 rounded-2xl border-l-4 border-[#BA0014] border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
              ...
              <ul className="space-y-4 text-gray-600 dark:text-gray-400">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Experienced site engineers, supervisors, technicians, and support staff</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Efficient handling of field setup, test execution, equipment coordination, and data collection</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Reliable operational support for highways, metro, rail, airport, and industrial projects</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-[#BA0014] rounded-full mr-3 mt-2 shrink-0"></div>
                  <span>Administrative and reporting coordination for smooth project execution</span>
                </li>
              </ul>
            </Card>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#BA0014] via-[#a00012] to-[#7f000d]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Driven by Experience. Built on Execution.</h2>
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Our team brings together leadership, engineering expertise, and practical field capability
            to deliver dependable foundation testing solutions.
          </p>
